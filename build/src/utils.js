        ...
        if ('type' in obj &&
            ...
            if (obj.type === 'HealthCheck' && 'healthCheckRating' in obj) {
                ...
                if ('diagnosisCodes' in obj) {
                    healthEntry = Object.assign(Object.assign({}, healthEntry), { diagnosisCodes: parseDiagnosisCodes(obj.diagnosisCodes) });
                }
                return healthEntry;
            }
            if (obj.type === 'OccupationalHealthcare' && 'employerName' in obj) {
                ...
                if ('sickLeave' in obj) {
                    occuEntry = Object.assign(Object.assign({}, occuEntry), { sickLeave: parseSickLeave(obj.sickLeave) });
                }
                return occuEntry;
            }
...
const parseHealthCheckRating = (rating) => {
    if (typeof rating === 'number' && (rating in Object.values(types_1.HealthCheckRating).filter(v => !isNaN(Number(v))))) {
        return rating;
    }
